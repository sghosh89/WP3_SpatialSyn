...
cdat<-cdat[,c(1,id4,id5,id6,id7)]# extract months 
...
saveRDS(cdat,here("RESULTS/year_by_site_tas_avgAprtoJuly.RDS"))
...
for(j in 1:nrow(df)){
  ...
  saveRDS(mat,paste(resloc,"/year_by_site_",climvar,"_avgAprtoJuly.RDS",sep=""))
  saveRDS(dmat,paste(resloc,"/year_by_site_",climvar,"_avgAprtoJuly_detrended.RDS",sep=""))
  
  saveRDS(d_allsite,paste(resloc,"/",climvar,"_data_avgAprtoJuly_selectedsitelist.RDS",sep=""))
  saveRDS(d_allsite_detrend,paste(resloc,"/",climvar,"_detrended_data_avgAprtoJuly_selectedsitelist.RDS",sep=""))
  print(j)
}
