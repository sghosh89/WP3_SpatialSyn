...
get_df<-function(yr_threshold){
  ...
  if(yr_threshold==40){
    outputresloc<-here("RESULTS/model_phylolm_sig75_0-250km")
    if(!dir.exists(outputresloc)){
      dir.create(outputresloc)
    }
  }else{
    outputresloc<-here(paste0("RESULTS/model_phylolm_sig75_0-250km_min",yr_threshold,"yr"))
    if(!dir.exists(outputresloc)){
      dir.create(outputresloc)
    }
  }
  ...
  if(yr_threshold==40){
    dfsig<-read.csv(here(paste0("RESULTS/abundance_spatsyn_nbin_",nbin,"_tail75sig_summary_0-250Km.csv")))
    dft<-read.csv(here(paste0("RESULTS/df_abund_climate_spatsyn_0_250km_nbin_",nbin,"_with_speciestraits.csv")))
  }else{
    dfsig<-read.csv(here(paste("RESULTS/abundance_spatsyn_nbin_",nbin,"_tail75sig_summary_0-250Km_min",yr_threshold,"yr.csv",sep="")))
  ...
  nm<-nm%>%distinct(BirdTreeName) # 180 unique species in BirdTree (32yr); 130 unique sp. (36yr.)
  ...
  if(yr_threshold==40){
    ...
    write.table(nm,here(paste("DATA/BirdTree/unique_speciesnameBirdTree_0_250km_nbin4_tailsig75_min",yr_threshold,"yr.txt",sep="")),quote=F,col.names =F,row.names=F)
  ...
  if(yr_threshold==32){
    sigT<-read.nexus(here(paste("DATA/BirdTree/sig75_0_250km_min",yr_threshold,"yr_tree-pruner-8b4540e8-83c7-4000-b36d-d96c95af384e/output.nex",sep="")))
  }
  
  if(yr_threshold==36){
    sigT<-read.nexus(here(paste("DATA/BirdTree/sig75_0_250km_min",yr_threshold,"yr_tree-pruner-c0788234-ebad-4aed-98e5-dfc5f730f40c/output.nex",sep="")))
  }
...
#============== model ===========
call_phylolm_sig75_0_250km_Nyrs_threshold<-function(model, yr_threshold){
...
call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas5_abs_td", yr_threshold=32)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr5_abs_td", yr_threshold=32)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas5", yr_threshold=32)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr5", yr_threshold=32)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas", yr_threshold=32)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr", yr_threshold=32)

#=====================================================

get_df(yr_threshold = 36)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas5_abs_td", yr_threshold=36)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr5_abs_td", yr_threshold=36)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas5", yr_threshold=36)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr5", yr_threshold=36)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas", yr_threshold=36)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr", yr_threshold=36)
...
call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas5_abs_td", yr_threshold=40)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr5_abs_td", yr_threshold=40)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas5", yr_threshold=40)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr5", yr_threshold=40)

call_phylolm_sig75_0_250km_Nyrs_threshold(model="tas", yr_threshold=40)
call_phylolm_sig75_0_250km_Nyrs_threshold(model="pr", yr_threshold=40)
