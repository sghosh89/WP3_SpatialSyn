...
call_summary_spat_syn_for_climate_Nyrs_threshold<-function(chosen_rad=c(0,250), climvar,nbin=4, yr_threshold=40){
  ...
  for(i in 1:nrow(df)){
    ...
    if(yr_threshold==40){
      ...
      resloc<-here(paste("RESULTS/yr_threshold_",yr_threshold,"/AOU_", givenAOU,"/",climvar,"_spatsyn_nbin_",nbin,sep=""))
      resloc.ab<-here(paste("RESULTS/yr_threshold_",yr_threshold,"/AOU_", givenAOU,"/abundance_spatsyn_nbin_",nbin,sep=""))
...
#----------------------
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr",nbin=4, yr_threshold=32)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr_avgAprtoAug",nbin=4, yr_threshold=32)

call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="tas",nbin=4, yr_threshold=32)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="tas_avgAprtoAug",nbin=4, yr_threshold=32)
#------------------------
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr",nbin=4, yr_threshold=36)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr_avgAprtoAug",nbin=4, yr_threshold=36)

call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="tas",nbin=4, yr_threshold=36)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="tas_avgAprtoAug",nbin=4, yr_threshold=36)
#--------------------
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr",nbin=4, yr_threshold=40)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr_avgAprtoAug",nbin=4, yr_threshold=40)

call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="tas",nbin=4, yr_threshold=40)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="tas_avgAprtoAug",nbin=4, yr_threshold=40)


# range: 0-100km
chosen_rad<-c(0,100) # within this distance category
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr",nbin=4, yr_threshold=40)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr_avgAprtoAug",nbin=4, yr_threshold=40)
...
# range: 100-250km
chosen_rad<-c(100,250) # within this distance category
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr",nbin=4, yr_threshold=40)
call_summary_spat_syn_for_climate_Nyrs_threshold(chosen_rad=chosen_rad, climvar="pr_avgAprtoAug",nbin=4, yr_threshold=40)
