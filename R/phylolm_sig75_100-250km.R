...
if(!dir.exists(here("RESULTS/model_phylolm_sig75_100-250km"))){
  dir.create(here("RESULTS/model_phylolm_sig75_100-250km"))
}
# ============= read data ==============
...
saveRDS(ct3,here("RESULTS/model_phylolm_sig75_100-250Km/consensus_tree_with_edgelength.RDS"))
...
pdf(here("RESULTS/model_phylolm_sig75_100-250km/species_phylogeny_100_250km_absolute_ab.pdf"), width = 9, height = 9) # Open a new pdf file
g1 # Write the grid.arrange in the file
dev.off()

pdf(here("RESULTS/model_phylolm_sig75_100-250km/species_phylogeny_100_250km_fLU_ab.pdf"), width = 9, height = 9) # Open a new pdf file
g2 # Write the grid.arrange in the file
dev.off()

pdf(here("RESULTS/model_phylolm_sig75_100-250km/species_phylogeny_100_250km_HWI.pdf"), width = 9, height = 9) # Open a new pdf file
g3 # Write the grid.arrange in the file
dev.off()

#============== model ===========
call_phylolm_sig75_100_250km<-function(model, df, ct3){
  ...
  if(model=="tas"){
    ...
    fitboot <- phylolm(fab.sig~ ftas.sig+HWI,data=df,
                       phy=ct3,model="lambda")
    myresloc<-here("RESULTS/model_phylolm_sig75_100-250km/model_tas")
    ...
    myresloc<-here("RESULTS/model_phylolm_sig75_100-250km/model_tas5")
    ...
    myresloc<-here("RESULTS/model_phylolm_sig75_100-250km/model_pr")
    ...
    fitboot <- phylolm(fab.sig~ fpr5.sig+HWI,data=df,
                       phy=ct3,model="lambda", boot=1000)
    myresloc<-here("RESULTS/model_phylolm_sig75_100-250km/model_pr5")
    ...
    myresloc<-here("RESULTS/model_phylolm_sig75_100-250km/model_tas5_abs_td")
    ...
    fitboot <- phylolm(abs.tot.td.ab.sig~ abs.tot.td.pr5.sig+HWI,data=df,
                       phy=ct3,model="lambda", boot=1000)
    myresloc<-here("RESULTS/model_phylolm_sig75_100-250km/model_pr5_abs_td")
...
#=====================================================
call_phylolm_sig75_100_250km(model="tas5_abs_td", df=df, ct3=ct3)
call_phylolm_sig75_100_250km(model="pr5_abs_td", df=df, ct3=ct3)

call_phylolm_sig75_100_250km(model="tas5", df=df, ct3=ct3)
call_phylolm_sig75_100_250km(model="pr5", df=df, ct3=ct3)

call_phylolm_sig75_100_250km(model="tas", df=df, ct3=ct3)
call_phylolm_sig75_100_250km(model="pr", df=df, ct3=ct3)
