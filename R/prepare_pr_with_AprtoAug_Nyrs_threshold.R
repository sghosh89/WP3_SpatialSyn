...
saveRDS(cdat,here("RESULTS/year_by_site_pr_avgAprtoAug.RDS"))
#======================

prepare_pr_with_AprtoAug_Nyrs_threshold<-function(cdat,yr_threshold=40,climvar="pr"){
...
#================
cdat<-readRDS(here("RESULTS/year_by_site_pr_avgAprtoAug.RDS"))
prepare_pr_with_AprtoAug_Nyrs_threshold(cdat=cdat,yr_threshold=32,climvar="pr")
prepare_pr_with_AprtoAug_Nyrs_threshold(cdat=cdat,yr_threshold=36,climvar="pr")
prepare_pr_with_AprtoAug_Nyrs_threshold(cdat=cdat,yr_threshold=40,climvar="pr")
