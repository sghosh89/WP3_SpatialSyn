...
summarize_res(chosen_rad = c(0,250)) # for visually testing Q2
```
...
```{r spat-syn-vs-distance-plot, echo=F, cache=T, cache.extra=list(mtime(here("R/spat_syn_vs_distance_plot.R")))}
source(here("R/spat_syn_vs_distance_plot.R")) # maybe put as suppmat
```
